// Vendored from @strudel/codemirror v1.3.0 (packages/codemirror/autocomplete.mjs).
// Modifications from upstream, GXW @ 2026-05-23:
//   - Rewritten imports: '../../doc.json' -> './doc.js', '@codemirror/autocomplete'
//     -> esm.sh URL, './html' -> './html.mjs'.
//   - Shimmed '@strudel/tonal' (`complex` becomes an empty object). Effect:
//     chord-handler still completes pitch names but not chord symbols. Wiring
//     real `complex` is a follow-up; see codemirror/README.md.
// Original AGPL-3.0-or-later license carried over via the repo-root LICENSE.

import jsdoc from './doc.js';
import { autocompletion } from "https://esm.sh/@codemirror/autocomplete@6?deps=@codemirror/state@6.5.2";
import { h } from './html.mjs';
// TODO: import { Scale } from '@tonaljs/tonal';
// TODO: import { soundMap } from '@strudel/webaudio';
let soundMap = undefined;
// TODO: import { complex } from '@strudel/tonal';  // chord-symbol completion
const complex = {};
